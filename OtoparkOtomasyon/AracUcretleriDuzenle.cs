...
{
    internal class AracUcretleriDuzenle
    {
                ...
                try
                {
                    ...
                    if (AracID == 1 || AracID == 2 || AracID == 3)
                    {
                        ...
                        if (aracUcret != null)
                        {
                            ...
                            MesajGoster.Bilgi("Ücretler başarıyla güncellendi!");
                        }
                        else
                        {
                            ...
                            entities.SaveChanges();
                            MesajGoster.Bilgi("Yeni ücret kaydı başarıyla eklendi!");
                        }
                    }
                    else
                    {
                        MesajGoster.Uyari("Geçersiz araç türü seçildi. Lütfen geçerli bir araç türü seçin!");
                    }
                }
                catch (Exception ex)
                {
