...
{
    internal class cs_OtoparkDoluluk
    {
        ...
        public cs_OtoparkDoluluk(cs_Baglanti baglanti, FlowLayoutPanel otomobilPanel, FlowLayoutPanel kamyonetPanel, FlowLayoutPanel minibusPanel)
        {
            _baglanti = baglanti;
